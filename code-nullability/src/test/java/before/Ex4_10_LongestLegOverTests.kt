...
import before.step2.Ex4_5_Legs.findLongestLegOver
...
class LongestLegOverTests3 {
    ...
    fun is_longest_leg_when_one_match() {
        assertEquals(
            "one day",
            /*
                코틀린에서 Optional. orElselhrow(）는 !!와 같다．
                자바 orElseThrow와 코틀린 !!는 값을 돌려주지만 값이 없으면 예외를 던진다.
             */
